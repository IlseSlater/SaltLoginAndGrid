                            ...
                            <div class="col-sm-6 col-sm-offset-3 form-box">
                                ...
                                <div class="form-bottom">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <asp:RequiredFieldValidator ID="rfvUsername" runat="server" ControlToValidate="txtUsername" ForeColor="Red" Text="Please type in Usename" ValidationGroup="vgAdd" />
                                    ...
                                    <div class="form-group">
                                        <label class="sr-only" for="form-password">Password</label>
                                        <asp:TextBox ID="txtPassword2" type="password" name="form-password" placeholder="Password..." class="form-password form-control" runat="server" TextMode="Password" MaxLength="15"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtPassword" ForeColor="Red" Text="Please type in matching password" ValidationGroup="vgAdd" />
                                    </div>
                                    <asp:Button ID="btnRegister" CssClass="btn" runat="server" Text="Register" Width="150px" OnClick="btnRegister_Click" ValidationGroup="vgAdd" />
